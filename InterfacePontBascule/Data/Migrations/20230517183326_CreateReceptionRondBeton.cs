...
{
    /// <inheritdoc />
    public partial class CreateReceptionRondBeton : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Diametre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReceptionRondBetons_TypeDeCamions_TypeDeCamionId",
                        column: x => x.TypeDeCamionId,
                        principalTable: "TypeDeCamions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReceptionRondBetons_TypeDeTransports_TypeDeTransportId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceptionRondBetons_TypeDeCamionId",
                table: "ReceptionRondBetons",
                column: "TypeDeCamionId");

            migrationBuilder.CreateIndex(
                name: "IX_ReceptionRondBetons_TypeDeTransportId",
                table: "ReceptionRondBetons",
